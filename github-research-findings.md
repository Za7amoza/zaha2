...
## github.com/topics/lead-generation -- 2026-05-26

*40 repos scored across 2 pages (sorted by stars). 1 already on skip list (awesome-n8n-templates). 7 new qualifying tools found. 32 filtered dev/scraper/ML/infra (score ≤6).*

### Found (7+)

- **Awaisali36/Outbound-Real-State-Voice-AI-Agent-** (42★) — **Score: 9** — Complete voice AI outbound calling system for real estate leads: VAPI + n8n + Airtable + Twilio. Auto-calls leads every 4 min during business hours, books Calendly appointments, sends WhatsApp/email follow-ups. n8n workflow JSON included, fully documented setup. ~$505–970/month to run at scale (100 calls/day). Direct RE wholesaling fit.
- **Othmane-Khadri/gtm-engineer-playbook** (41★) — **Score: 9** — 10 installable Claude Code skills for GTM ops: ICP Architect, Signal Scanner, Account Research Brief, Qualification Scorer (HOT/WARM/COLD/PARK), Outreach Sequence Builder, Meeting Prep Brief, Competitive Battlecard Generator + 3 bonus skills. Skills chain together. `install.sh` drops into `.claude/skills/`. Pure Claude Code agentic OS addition.
- **sales-skills/sales** (28★) — **Score: 9** — 100+ Claude Code skills for sales/GTM: prospecting, pipeline mgmt, discovery, demos, proposals, objection handling, Apollo/Salesloft/Outreach integration, email validation, CRM automation, call intelligence. Entry point: `/sales-do` (plain-language router). 543 commits, active. `npx skills add sales-skills/sales --skill sales-do`.
- **toofast1/awesome-ai-lead-generation** (44★) — **Score: 8** — Curated list of AI lead gen tools: social listening (Leado/Reddit, Awario, GummySearch), scraping/enrichment (Apollo, Clay, PhantomBuster), cold outreach (Instantly, Lavender, Lemlist), voice agents (Bland AI, VAPI, Synthflow), AI copywriting (Copy.ai, Jasper, Taplio). Good discovery map for Adam's outreach stack.
- **ominou5/funnel-architect-plugin** (55★) — **Score: 8** — Claude Code plugin with 5 agents + 29 skills for building sales funnels: supports 13 funnel types (opt-in, VSL, high-ticket, application, evergreen webinar, etc.). Handles copywriting, page optimization, mobile responsiveness, deployment (Vercel/Netlify). Real estate wholesaling high-ticket funnel use case directly applicable.
- **BraaMohammed/bricks** (31★) — **Score: 8** — Fully local open-source Clay.com alternative. Web research agents, AI email finder with validation, dual-agent outreach pressure-testing, Puppeteer browser automation — no scraping API fees. Self-host or use hosted version at use-bricks.netlify.app. Eliminates Clay's $200–400/month subscription. TypeScript/Next.js, 64 commits.
- **getaero-io/gtm-eng-skills** (20★) — **Score: 8** — 10 Claude Code skills for GTM via Deepline CLI (40+ data providers: Apollo, Crustdata, PDL, Hunter, LeadMagic, etc.): `build-tam`, `linkedin-url-lookup`, `portfolio-prospecting`, `niche-signal-discovery`, `clay-to-deepline` migration, waterfall enrichment. 137 commits, active. Complements gtm-engineer-playbook for full outbound stack.

### Filtered

- **32 repos filtered (score 1–6):** omkarcloud/google-maps-scraper (2.7k★), cporter202/API-mega-list (5.5k★), buyukakyuz/email-sleuth (408★), kaymen99/sales-outreach-automation-langgraph (297★), cullenwatson/StaffSpy (254★), Madi-S/Lead-Generation (232★), keegn/gatsby-starter-saas-marketing (223★), ScrapingBee/google-reviews-scraper (217★), Othmane-Khadri/YALC-the-GTM-operating-system (204★ — CLI-first dev tool), omkarcloud/google-maps-reviews-scraper (172★), superryeti/Email-Crawler-Lead-Generator (178★), cporter202/agentic-ai-starters (145★), iPythoning/b2b-sdr-agent-template (102★), ZiaUrR3hman/LinkedSocialToolkit (101★), asiifdev/business-leads-ai-automation (92★), kaymen99/ai-web-scraper (78★), sangaline/email-spy (76★), mukulsinghal001/lead-scoring-model-python (68★), webAutomationLover/google-map-scraper (60★), omkarcloud/g2-scraper (59★), cporter202/software-income-playbooks (58★), leadita/tech-stack-datasets (55★), brightdata/ai-lead-generator (48★), Awaisali36/50k-lead-generation-system (45★), kaymen99/google-maps-lead-generator (36★), jeffo777/input-right (36★), Nuclear-Marmalade/dataforge (32★), Linked-API/linkedin-cli (28★), Propels-AI/Propels (24★), christivn/mapScraper (23★), man0l/zero-gtm (23★), Rezzecup/TraderLeadFinder (20★). All require developer setup (Python, TypeScript, CLI scraping libraries, ML models) or are too narrowly technical for non-dev use.

---

## github.com/topics/email-automation -- 2026-05-27

*40 repos scored across 2 pages (sorted by stars). 8 new qualifying tools found. 32 filtered dev/infra/spam/Apple-only (score ≤6).*

### Found (7+)

- **emretasss/AI-Workflow-Hub-2000-** (259★) — **Score: 7** — 2,000+ free N8N AI automation workflow templates in a single hub. Direct companion to n8n for anyone building outreach, lead-gen, or ops pipelines without writing code. No setup needed beyond having n8n running — browse, copy, deploy.
- **aomail-ai/aomail-app** (61★) — **Score: 8** — AI interface that wraps Gmail, Outlook, or any IMAP inbox. Auto-categorises emails, writes summaries, suggests replies. No-code setup. Adam uses Gmail (adam.dak.lm@gmail.com) — direct plug-in. Reduces inbox zero time for high-volume outreach follow-ups.
- **shuakami/mcp-mail** (48★) — **Score: 8** — MCP server for AI-powered email management via IMAP/SMTP. Plugs into Claude Code / Claude Desktop directly so Adam can ask Claude to "reply to all unread leads from today" natively inside his agentic OS. IMAP = works with any mailbox.
- **krishna-build/claude-coach-kit** (29★) — **Score: 8** — Open-source marketing automation toolkit for coaches & solopreneurs: email sequences, drip campaigns, analytics — no dev background required. Claude-native, designed for individual operators. Relevant for RE wholesaling list-nurturing and follow-up cadences.
- **XenoXilus/outlook-mcp** (24★) — **Score: 8** — MCP server for Office 365 Outlook covering email, calendar, and SharePoint — fully compatible with Claude, ChatGPT, and AI assistants. Useful if Adam's buyers/title companies run Outlook-based corporate email.
- **LeadMagic/smartlead-mcp-server** (18★) — **Score: 9** — Official MCP server for SmartLead, the leading cold-email SaaS. 113 tools covering campaign creation, inbox rotation, lead management, reply handling, analytics. Wires SmartLead directly into Claude Code so Adam can run "launch a 5-step sequence to 200 cash buyers" as a single agentic command. Core stack for outbound RE wholesaling.
- **littlebearapps/outlook-assistant** (18★) — **Score: 8** — MCP server for Outlook (email + calendar + contacts) for AI assistants. Lets Claude manage meetings with title agents, respond to seller emails, sync contacts — all without leaving Claude Code.
- **Dominien/hubspot-sales-agent** (11★) — **Score: 9** — Autonomous sales agent on top of HubSpot CRM: bulk outreach, inbox classification, research-driven personalization, lead recovery. Runs end-to-end outbound from HubSpot without manual touchpoints. If Adam moves to a HubSpot-based RE CRM, this is the automation layer.

### Filtered

**32 repos filtered (score 1–6):** skernelx/tavily-key-generator (1.5k★ — API key generator, dev), DjangoCRM/django-crm (568★ — requires Django deployment), vitorfs/colossus (562★ — self-hosted Django email marketing), kaymen99/langgraph-email-automation (251★ — LangGraph ML dev), transitive-bullshit/puppeteer-email (167★ — headless browser dev), PaulleDemon/Email-automation (149★ — cold email tool but Python dev setup), tunak94875208/sp4rk-ma1l-S26 (139★ — suspicious/synthetic), KatrielMoses/MailAccess (96★ — email OSINT tool), quambene/pigeon-rs (82★ — Rust dev), s-morgan-jeffries/apple-mail-mcp (77★ — Apple-only, Adam on Windows), heripo-lab/llm-newsletter-kit-core (43★ — dev framework), msinamsina/pyautomail (39★ — Python dev), ystemsrx/Application-Monitoring (31★ — sysadmin), techflow-oficial/job-tracker-pro (31★ — minor), gmickel/outlookctl (27★ — Outlook CLI/dev), XenoXilus/outlook-mcp variant XyvaClaw (18★ — vague platform), SagarBiswas-MultiHAT/EmailBomber (20★ — spam tool, skip), Pasindunabesinghe/Automated-Dropshipping (19★ — dropshipping, off-topic), KnoWhiz/DoWhiz (18★ — vague/unclear), agentmail-to/agentmail-examples (15★ — dev examples), shan18/Python-Automation-Scripts (14★ — dev scripts), kerbelp/z-mail-agent (13★ — LangGraph dev), igptai/igptai-python (13★ — SDK), igptai/igptai-node (13★ — SDK), spree-contrib/spree_mailchimp_ecommerce (12★ — dev), ansifi/email_automation_tool (12★ — scraper), Dominien/hubspot-sales-agent (11★ — kept above), thekamik/email-automation-with-gpt (11★ — dev), Raghul-M/gmail-sender-action (11★ — GitHub Action dev), Mahdi-hasan-shuvo/Email-Sender-Software (11★ — bulk sender GUI, score 5), Altafalam3/Email-Assistant-Agents (10★ — Autogen dev), riteshkarmakar/bulk-email-sender (10★ — Python GUI dev).

---

## github.com/topics/cold-email -- 2026-05-27

*40 repos scored across 2 pages (sorted by stars). 7 already on skip list (awesome-ai-lead-generation, markster-os, sales-skills/sales, smartlead-mcp-server/LeadMagic, next-level-outreach, harvey, awesome-ai-sales-tools). 7 new qualifying tools found. 26 filtered dev/CLI/dataset/off-topic (score ≤6).*

### Found (7+)

- **buyukakyuz/email-sleuth** (408★) — **Score: 7** — Email discovery + verification by name + domain. Finds professional contact emails without scraping fees. Useful for locating seller or cash-buyer contacts when only a name and company URL are known. 408 stars, actively maintained.
- **buildingopen/opengtm** (7★) — **Score: 8** — Open-source alternative to Clay/Apollo: lead gen + enrichment + outreach automation in one self-hostable platform. Eliminates dependency on expensive SaaS for prospecting pipelines. Early-stage but directly addresses Adam's outbound RE wholesaling workflow.
- **concaption/cold-md** (7★) — **Score: 8** — A single markdown file that instructs an AI agent to run a complete cold outreach sequence. Drop-in Claude Code skill for cold email without building anything. Perfect plug-and-play addition to Adam's agentic OS.
- **txampa/claude-skill-b2b-local-outreach** (6★) — **Score: 9** — Claude Code skill for B2B local outreach: includes email discovery, contact enrichment, and multilingual support (useful for Cairo-based operations reaching English-speaking US RE contacts). Install directly into `.claude/skills/`.
- **julienamorgan/signal-prospecting-kit** (5★) — **Score: 9** — Six Claude Code skills that detect buying signals in prospects (web, LinkedIn, news events) and auto-draft contextual outreach messages. Chains into cold-email sequences natively. Ideal for identifying motivated sellers by activity signals.
- **braedonsaunders/trawl** (5★) — **Score: 7** — B2B lead platform: discovers businesses via Google Maps, enriches records with AI tools, scores prospect fit, and automates personalized outreach locally. Useful for area-based motivated seller discovery in US wholesale markets.
- **JosieBot26/prospector-mcp-email-finder** (3★) — **Score: 7** — Free MCP email finder and SMTP verification without paid API subscriptions. Plugs directly into Claude Code. Finds and validates contact emails for free at any volume — zero cost alternative to Hunter.io or Apollo enrichment.

### Filtered

**26 repos filtered (score 1–6):** postcli/adityajha2005 (18★ — CLI/dev tool), job-cd/avayabaniya (10★ — job search, off-topic), coldflow/pypesdev (10★ — unclear tool, no documentation), autogtm/cmn-labs (9★ — too low stars, unverified), cold-email-cli/LeadMagic (7★ — CLI dev tool), b2b-email-leads-ranking/b2bemaillists (7★ — raw dataset, not a tool), smartlead-mcp-server/win8428 (7★ — duplicate of LeadMagic version on skip list), smart-trade-ai/chefroger (6★ — international trade focus, not RE), trade-show-email-templates/LensmorOfficial (6★ — templates only, no automation), cold-cli/andersmyrmel (5★ — Go CLI dev tool), directory-intelligence-tool/royaltybynuture-star (4★ — vague, very low stars), Open-Email-Marketing-Dataset/emailmarketingdataset (4★ — dataset only), JobHunter-AI/sharmadivy917-ops (4★ — job search tool), b2b-outbound-sniper/getlemnos32 (3★ — dev-oriented, low stars), ai-sales-agent-simulator/ndpvt-web (3★ — Streamlit dev app), gmail-api-outreach-system/dikshant182004 (3★ — Python dev setup required), ai-cold-email-campaign-manager/u3ffrzi (3★ — enterprise dev), prospector-mcp-email-finder/JosieBot26 (3★ — kept above), RevSculpt-Inbox/George-RevSculpt (3★ — deliverability scanner only), ai-sdr-agent/kandksolvefast (2★ — 2 stars, unverified), writepro-prompts/Kejihanliang (2★ — foreign trade focus, not RE), B2B-Sales-Agent/stergios-ziliaskopoulos (2★ — Streamlit/dev), Superkabe/Superkabereal (2★ — deliverability platform only), AI-Powered-Cold-Email-Generator/EngrEeshaKhan (2★ — Streamlit dev app), awesome-lead-generation/adops-tool (2★ — too low stars), oneshot-gtm/oneshot-agent (2★ — CLI-first, 2 stars), b2b-sdr-agent-template/iPythoning (105★ — template, requires dev setup to deploy).
...
- **getbeton/beton-ai** (72★) — **Score: 7** — Open-source revenue intelligence platform for sales enrichment and lead generation. Provides company/contact enrichment similar to Apollo or ZoomInfo but self-hostable. Useful for building enriched motivated-seller contact lists without per-record API fees.
- **prospectio-ai/prospectio-api-mcp** (19★) — **Score: 7** — MCP server bridging Claude Code to multiple lead generation platforms (Apollo, Hunter, etc.). Single integration point — ask Claude "find 50 off-market property owners in Phoenix" and it routes to available data providers automatically. Drop-in prospecting primitive for Adam's agentic OS.
- **explorium-ai/vibeprospecting-plugin** (10★) — **Score: 8** — B2B data plugin for AI chat: powers lead list creation, company research, and contact enrichment directly from conversational prompts. No-code — works inside any AI assistant that accepts plugins. Drop-in intelligence layer for motivated seller or cash buyer research.
- **kvivek0591/linkedin-lookback** (5★) — **Score: 7** — Chrome extension that logs LinkedIn activity (profile views, post interactions, connection history) as persistent sales context. Gives Adam recall of every LinkedIn touch without relying on memory — useful for following up with buyers or RE investors across a long campaign.
- **Mantyl-ai/mantyl-sequence-generator** (3★) — **Score: 8** — AI outbound engine: inputs an ICP description and outputs personalized multi-channel sequences (email + LinkedIn) in 60 seconds. No manual copywriting. For RE wholesaling: define "cash buyer in Dallas" → get fully drafted 5-step outreach sequence instantly.
- **toflow-ai/toflow-mcp** (3★) — **Score: 8** — MCP server for toflow.ai workspace that automates prospecting, data enrichment, and multi-channel outreach end-to-end. Plugs directly into Claude Code so Adam can run full prospecting + send workflows as single agentic commands, from ICP definition to sent message.
- **Atum246/keelead** (3★) — **Score: 8** — Open-source AI lead gen engine with a ChatGPT-style interface (no code required), 62 integrated data sources, email verification, company research, and a built-in MCP server for Claude Code. Self-hostable Apollo/Clay alternative combining discovery + enrichment + verification in one non-technical UI.
- **noobships/reacher-x** (2★) — **Score: 7** — AI agent spanning X/Twitter and LinkedIn: autonomously finds, qualifies, enriches, and initiates contact with target prospects. Useful for identifying and first-touching cash buyers or RE investors active on social, cutting manual research time for outbound campaigns.
- **SynchroniaLabs/easy-leads** (2★) — **Score: 7** — Desktop app (Windows/Mac) that extracts business leads from Google Maps by keyword/area and exports to Excel. Zero setup — no CLI, no Python, just download and run. Practical for local market prospecting: "real estate investors in Memphis" → formatted contact sheet in minutes.
- **Riganito/Witty-AI** (2★) — **Score: 7** — AI sales agent that handles every prospecting step autonomously so Adam stays focused on closing calls rather than research. Routes through discovery, qualification, and outreach prep without manual touchpoints. Early-stage but promising as orchestration layer for RE outbound.

### Filtered

**23 repos filtered (score 1–6):** ZiaUrR3hman/LinkedSocialToolkit (101★ — Python script, requires dev setup), FlaSpaceInst/EZ-RASSOR (61★ — space mining robot, completely irrelevant), christivn/mapScraper (23★ — Python scraper, dev), maximo3k/apollo-search-scraper (14★ — dev scraper), yousefkotp/local-leads-finder (11★ — Python code tool), hatimhtm/LeadSniper (4★ — dev setup required), paulogirto-hub/prospector (4★ — dev platform), raghavshahhh/lead-genrater (3★ — dev automation bot), vexato/LeadMiner (3★ — Python CLI), vinkius-labs/crewai-mcp-lead-gen-agents (2★ — CrewAI framework dev), dipankar/apollo-io-cli (2★ — CLI dev tool), LeadMagic/leadmagic-openapi (2★ — API spec only), Ibrahim-3d/prospector (2★ — dev scraper), amart19D/icp-prospector (2★ — startup/tech ICP focused, not RE), JuanquiFortuny/prospector-mcp-email-finder (2★ — fork of skip-listed repo), anthonyonazure/maps-lead-gen (1★), theHarlequins/leadminer-ultimate (1★), Inferensys/apollo-io-mcp (1★), farizrifqi/prospecting-discord-bot (1★ — Roblox game bot, irrelevant), capt-marbles/attio (1★ — OpenClaw integration, 1 star), ImRicoAi/prospect-finder (1★ — CLI), closespark/ProspectPilot (1★), TSP66/Monte-Carlos-Loamer (1★ — actual gold prospecting tool, irrelevant).
